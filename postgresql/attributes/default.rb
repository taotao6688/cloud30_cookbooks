...
default['postgresql']['default_pkg'] = ["postgresql93","postgresql93-libs","postgresql93-server"]

default['postgresql']['repo_dir'] = "/etc/yum.repos.d"
default['postgresql']['name'] = "pgsql_local.repo"
default['postgresql']['gpgcheck'] = "0"
