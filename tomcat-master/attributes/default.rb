...
default['tomcat']['tomcat_tar']="apache-tomcat-#{node["tomcat"]["full_version"]}.tar.gz"

case node['platform']
when 'centos', 'redhat', 'fedora', 'amazon'
  default['tomcat']['user'] = 'tomcat'
  default['tomcat']['group'] = 'tomcat'
  default['tomcat']['home'] = "/etc/tomcat#{node["tomcat"]["base_version"]}"
  default['tomcat']['base'] = "/etc/tomcat#{node["tomcat"]["base_version"]}"
  default['tomcat']['config_dir'] = "/etc/tomcat#{node["tomcat"]["base_version"]}"
  default['tomcat']['log_dir'] = "/etc/tomcat#{node["tomcat"]["base_version"]}/logs"
  default['tomcat']['tmp_dir'] = "/etc/tomcat#{node["tomcat"]["base_version"]}/temp"
  default['tomcat']['work_dir'] = "/etc/tomcat#{node["tomcat"]["base_version"]}/work"
  default['tomcat']['context_dir'] = "#{node["tomcat"]["config_dir"]}/Catalina/localhost"
  default['tomcat']['webapp_dir'] = "/etc/tomcat#{node["tomcat"]["base_version"]}/webapps"
