...
default[:mongodb][:group] = 'mongodb'
 #default['tomcat']['config_dir'] = '/etc/mongodb'
...
default[:mongodb][:reload_action] = 'restart'
...
#default['mongodb']['default_pkg'] = ["mongodb-org-server-2.6.0-1.x86_64.rpm","mongodb-org-mongos-2.6.0-1.x86_64.rpm","mongodb-org-shell-2.6.0-1.x86_64.rpm","mongodb-org-tools-2.6.0-1.x86_64.rpm","mongodb-org-2.6.0-1.x86_64.rpm"]
 default['mongodb']['default_pkg'] = ["mongodb-org"]

 default[:mongodb][:package_name] = 'mongodb-server'

default['mongodb']['repo_dir'] = "/etc/yum.repos.d"
default['mongodb']['name'] = "MongoDB_Local.repo"
default['mongodb']['gpgcheck'] = "0"
