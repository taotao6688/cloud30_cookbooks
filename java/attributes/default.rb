...
default['java']['jdk_source'] = 'jdk-7u51-linux-x64.tar.gz'
...
# x86_64
default['java']['jdk']['6']['x86_64']['url'] = "#{node[java]['source_path']}/node['java']['jdk_source']"
default['java']['jdk']['6']['x86_64']['checksum'] = '764f96c4b078b80adaa5983e75470ff2'
